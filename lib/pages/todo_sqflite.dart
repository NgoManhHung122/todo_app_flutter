...
import 'package:todo_app_flutter/services/local/todo_database.dart';

class TodoSqflite extends StatefulWidget {
  const TodoSqflite({super.key, required this.title});

  final String title;

  @override
  State<TodoSqflite> createState() => _TodoSqfliteState();
}

class _TodoSqfliteState extends State<TodoSqflite> {
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return TodoItem(
                                  ...
                                  onEdit: () async {
                                    todo =
                                        await AppDialog.editTodo(context, todo);
                                    await db.updateTodo(todo);
                                    setState(() {});
                                  },
                                  onDelete: () {
